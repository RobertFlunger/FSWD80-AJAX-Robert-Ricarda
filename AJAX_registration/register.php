...
<body>
	...
	<form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
		...
		<input type="email" id="email" name="email" class="form-control my-3" placeholder="Enter Your Email" maxlength="50" value="<?php echo $email ?>"/>
			<span class = "text-danger" id="emailFormErr"><?php echo $emailError; ?></span>

		<input type="password" id="pass1" name="pass" class="form-control my-3" placeholder="Enter Your Password" maxlength="20"/>
		...
		<input type="password" id="pass2" name="pass2" class="form-control my-3" placeholder="Repeat Password" maxlength="20"/>
		<span class = "text-danger" id="pass2FormErr"></span>
			<hr>
